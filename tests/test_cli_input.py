...
def mock_prompt_session():
    ...
    with patch("PhyAgentOS.cli.commands._PROMPT_SESSION", mock_session), \
         patch("PhyAgentOS.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("PhyAgentOS.cli.commands.PromptSession") as MockSession, \
         patch("PhyAgentOS.cli.commands.FileHistory") as MockHistory, \
