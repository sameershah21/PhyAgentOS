...
def _make_loop():
    ...
    with patch("PhyAgentOS.agent.loop.ContextBuilder"), \
         patch("PhyAgentOS.agent.loop.SessionManager"), \
         patch("PhyAgentOS.agent.loop.SubagentManager") as MockSubMgr:
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("PhyAgentOS.agent.tools.registry.ToolRegistry.execute", fake_execute)
